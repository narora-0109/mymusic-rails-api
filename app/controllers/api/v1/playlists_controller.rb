class Api::V1::PlaylistsController <  Api::V1::ApplicationController
  PERMITTED_PARAMETERS = [:title,:user_id ,tracks_attributes: [:title, :time], albums_attributes: [:title, :year], user_attributes:[:name, :email, :password, :password_confirmation, :role]]
